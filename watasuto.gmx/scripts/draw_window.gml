...
// center_top
draw_sprite_part_ext(spr, argument1, l_w, 0, m_w, t_h, px+l_w, py , (w-l_w-r_w)/m_w, 1, c_white, image_alpha)
// right_top
draw_sprite_part(spr, argument1, sprite_get_width(spr) - r_w, 0, r_w, t_h, px+w-r_w ,py)

// left_middle
draw_sprite_part_ext(spr, argument1, 0, t_h, l_w, m_h, px, py+t_h, 1, (h-t_h-b_h)/m_h, c_white, image_alpha)
// center_middle
draw_sprite_part_ext(spr, argument1, l_w, t_h, m_w, m_h, px+l_w, py+t_h, (w-l_w-r_w)/m_w, (h-t_h-b_h)/m_h, c_white, image_alpha)
// right_middle
draw_sprite_part_ext(spr, argument1, sprite_get_width(spr) - r_w, t_h, r_w, m_h, px+w-r_w, py+t_h, 1, (h-t_h-b_h)/m_h, c_white, image_alpha)

// left_bottom
draw_sprite_part(spr, argument1, 0, sprite_get_height(spr) - b_h, l_w, b_h, px, py+h-b_h)
// center_bottom
draw_sprite_part_ext(spr, argument1, l_w, sprite_get_height(spr) - b_h, m_w, b_h, px+l_w, py+h-b_h, (w-l_w-r_w)/m_w, 1, c_white, image_alpha)
// right_bottom
